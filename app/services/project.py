...
def check_member(db: Session, project: Project, current_user: UserModel):
    """Cho phép OWNER hoặc bất kỳ MEMBER nào của project."""
    if project.owner_id == current_user.id:
        return
...
def is_project_member(db: Session, project: Project, user_id: str) -> bool:
    """Kiểm tra user_id có phải owner hoặc member của project không."""
